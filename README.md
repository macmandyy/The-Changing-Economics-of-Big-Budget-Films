...
While production budget remains positively correlated with revenue, this relationship has become significantly more fragile in the post-COVID era. Year to year correlation fluctuates rather than stabilizes, suggesting increased uncertainty in big budget investments.
...
* Despite these limitations, the analysis highlights meaningful shifts in risk dynamics within our modern film production landscape.
...
This project was designed to explore real world financial risk in a creative industry, combining API data collection, feature engineering, exploratory analysis, and data visualization to answer a contemporary business question. It was also designed with the intention of self learning Python as well as other tools for data analysis and visualization. 
